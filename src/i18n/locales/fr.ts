...
export const fr: Record<string, Phrase> = {
  ...
  'more.title': 'Plus',
  'more.subtitle': 'Tous vos outils, à un seul endroit.',
  'more.spendingDesc': "L'historique de vos dépenses",
  'more.incomeDesc': "L'argent qui entre",
  'more.billsDesc': 'Factures et frais récurrents',
  'more.debtDesc': 'Rembourser, une étape à la fois',
  'more.goalsDesc': 'Suivez ce pour quoi vous épargnez',
  'more.searchDesc': "Trouvez n'importe quel paiement ou dépense",
  'more.activityDesc': 'Chaque paiement, du plus récent au plus ancien',
  'more.breakdownDesc': 'Vos dépenses par catégorie',
  'more.calendarDesc': "Votre mois en un coup d'œil",
  'more.currencyDesc': 'Convertir des devises, même hors ligne',
  'more.profileDesc': 'Photo, nom, données et confidentialité',
  'more.settingsDesc': 'Préférences, exportation, partage et à propos',
  'breakdown.title': 'Bilan du mois',
  'breakdown.nothingHere': 'Rien ici ce mois-ci.',
  'common.previousMonth': 'Mois précédent',
  'common.nextMonth': 'Mois suivant',
  'settings.appearanceDesc': 'Clair, sombre, ou selon votre appareil',
  'settings.languageDesc': 'English, Français, Español, Português, 中文',
  'settings.exportDesc': 'Enregistrer ou partager une copie de vos données',
  'settings.shareDesc': "Parler de PeggyBank à quelqu'un",
  'settings.reminderLevel': 'Niveau de rappels',
  'settings.reminderIntro': 'Choisissez à quelle fréquence PeggyBank vous fait signe.',
  'settings.levelOff': 'Aucun',
  'settings.levelOffDesc': 'Aucun rappel',
  'settings.levelMinimal': 'Minimal',
  'settings.levelMinimalDesc': 'La veille, et le jour même',
  'settings.levelDetailed': 'Détaillé',
  'settings.levelDetailedDesc': "Chaque jour pendant la semaine précédant l'échéance",
  'settings.blocked': 'Les notifications sont bloquées',
  'settings.testDesc': 'Vérifier que les rappels fonctionnent',
};
