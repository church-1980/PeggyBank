...
export const en: Record<string, Phrase> = {
  ...
  'more.title': 'More',
  'more.subtitle': 'All your tools, in one calm place.',
  'more.spendingDesc': 'Your expense history',
  'more.incomeDesc': 'Money coming in',
  'more.billsDesc': 'Recurring bills and charges',
  'more.debtDesc': 'Pay it down, one step at a time',
  'more.goalsDesc': "Track what you're saving for",
  'more.searchDesc': 'Find any payment or expense',
  'more.activityDesc': 'Every payment, newest first',
  'more.breakdownDesc': 'See your spending by category',
  'more.calendarDesc': 'See your month at a glance',
  'more.currencyDesc': 'Convert money, works offline',
  'more.profileDesc': 'Photo, name, data & privacy',
  'more.settingsDesc': 'Preferences, export, share & about',
  'breakdown.title': 'Monthly Breakdown',
  'breakdown.nothingHere': 'Nothing here this month.',
  'common.previousMonth': 'Previous month',
  'common.nextMonth': 'Next month',
  'settings.appearanceDesc': 'Light, dark, or follow your device setting',
  'settings.languageDesc': 'English, Français, Español, Português, 中文',
  'settings.exportDesc': 'Save or share a copy of your data',
  'settings.shareDesc': 'Let someone know about PeggyBank',
  'settings.reminderLevel': 'Notification Level',
  'settings.reminderIntro': 'Choose how often PeggyBank checks in with you.',
  'settings.levelOff': 'Off',
  'settings.levelOffDesc': 'No reminders at all',
  'settings.levelMinimal': 'Minimal',
  'settings.levelMinimalDesc': 'A day before, and on the day',
  'settings.levelDetailed': 'Detailed',
  'settings.levelDetailedDesc': 'Every day for the whole week before it is due',
  'settings.blocked': 'Notifications are blocked',
  'settings.testDesc': 'Check notifications are working',
};
