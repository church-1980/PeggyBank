...
export const TABLE_CLASSIFICATION: TableFact[] = [
  ...
  { table: 'debt_payments',      classification: 'BACKED_UP', reason: 'Real payments made towards a debt, dated and individually correctable. Losing this would make paid-down debt look untouched.', createdIn: 'src/database/database.ts' },
